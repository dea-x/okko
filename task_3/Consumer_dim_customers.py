...
def parse(line):
    ...
    return data['customer_id'], data['country'], data['city'], data['phone'], data['first_name'], data['last_name'], \
           data['mail'], data['last_update_date']
...
def save_data(rdd):
    if not rdd.isEmpty():
        ...
        result = spark.sql(
            "select _1 as customer_id,_2 as country,_3 as city,_4 as phone,_5 as first_name,_6 as last_name,_7 as mail,to_timestamp(_8) as last_update_date from t")
