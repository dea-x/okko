...
def parse(line):
    ...
    return data['event_time'], data['event_type'], data['event_id'], data['product_id'], data['category_id'], data['category_code'], data['brand'], data['price'], data['customer_id']
...
def save_data(rdd):
    if not rdd.isEmpty():
        ...
        result = spark.sql("select to_timestamp(_1) as event_time,_2 as event_type,_3 as event_id,_4 as product_id,_5 as category_id,_6 as category_code,_7 as brand,_8 as price,_9 as customer_id from t")
